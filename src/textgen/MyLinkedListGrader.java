...
public class MyLinkedListGrader {
	...
	//	System.out.println("2) "+lst.size());
		...
		lst.add(0, 1);
		//System.out.println("forward2 : "+printListForwards(lst));
		lst.remove(0);
		lst.add(0, 1);
                feedback += "Got " + printListForwards(lst) + ". ";
